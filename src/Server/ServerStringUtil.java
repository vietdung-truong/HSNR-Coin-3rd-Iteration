...
public class ServerStringUtil {
	...
	public static void setX9Params(X9ECParameters x9Params) {
		ServerStringUtil.x9Params = x9Params;
	}
	...
	public static String getMerkleRoot(ArrayList<ServerTransaction> transactions) {
		int count = transactions.size();
		ArrayList<String> previousTreeLayer = new ArrayList<String>();
		for (ServerTransaction transaction : transactions) {
