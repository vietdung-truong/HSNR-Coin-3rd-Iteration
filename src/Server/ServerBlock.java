...
public class ServerBlock {
	...
	public String merkleRoot; // Block beinhaltet merkleroot, bedeutet fusioniertes hash von allen hashes von
								// transaktionen
	public ArrayList<ServerTransaction> transactions = new ArrayList<ServerTransaction>();
	public long timeStamp;
	static int nonce;
	public String testHash;

	public ServerBlock(String previousHash) {
		super();
		this.previousHash = previousHash;
		testHash = calculateHash();
	...
	public String calculateHash() {
		...
		String calculatedHash = ServerStringUtil
	...
	public void mineBlock(int difficulty) {
		merkleRoot = ServerStringUtil.getMerkleRoot(transactions);
	...
	public boolean addTransaction(ServerTransaction transaction) {
